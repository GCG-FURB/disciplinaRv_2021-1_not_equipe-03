...
public class Necessidades : MonoBehaviour
{
    ...
    public AudioClip clipEating;
    public AudioClip clipDrinking;
    public AudioClip clipKiding;
    public AudioClip clipPopup;
        ...
        if (instanciou)
        {
            if (!conta)
            {
                ...
                if (tipoInstanciado == 1)
                {
                    ...
                    directionThreshold = 0.1f;
                    positionLengthThresholdMin = 0f;
                    positionLengthThresholdMax = 15f;
                    positionYThresholdMin = -5f;
                    positionYThresholdMax = 5f;
                }
                else if (tipoInstanciado == 2)
                {
                    ...
                    directionThreshold = 0.1f;
                    positionLengthThresholdMin = -5f;
                    positionLengthThresholdMax = 5f;
                    positionYThresholdMin = 0;
                    positionYThresholdMax = 10;
                }
                else if (tipoInstanciado == 3)
                {
                    ...
                    positionLengthThresholdMin = 0f;
                    positionLengthThresholdMax = 15f;
                    positionYThresholdMin = -10f;
                    positionYThresholdMax = 10f;
                }
                ...
                if (Verificador.posicaoCorreta(modeloInstanciado, direcao, directionThreshold, positionLengthThresholdMin, positionLengthThresholdMax, positionYThresholdMin, positionYThresholdMax, eixoDirecao))
                {
                    if (tipoInstanciado == 1)
                    {
                        ...
                        aSource.PlayOneShot(clipDrinking);
                    }
                    else if (tipoInstanciado == 2)
                    {
                        ...
                        aSource.PlayOneShot(clipEating);
                    }
                    else if (tipoInstanciado == 3)
                    {
                        ...
                        aSource.PlayOneShot(clipKiding);
                    }
