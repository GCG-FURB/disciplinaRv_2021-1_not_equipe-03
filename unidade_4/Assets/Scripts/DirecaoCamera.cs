...
public static class DirecaoCamera //: MonoBehaviour
{
    ...
    //         float cameraXThreshold, float cameraYThresholdMin,float cameraYThresholdMax, Axis axis)
    //     {
    ...
    //         var isYAxisCorrect = deltaY > cameraYThresholdMin && deltaY < cameraYThresholdMax;
    ...
    //     }
        ...
        public static bool[] IsCameraPositionCorrect(Camera cam, GameObject outOfPathBlock, 
            float cameraXThresholdMin,float cameraXThresholdMax, float cameraYThresholdMin,float cameraYThresholdMax, Axis axis)
        {
            var camPosition = cam.gameObject.transform.position;
            var blockPosition = GetPosition(outOfPathBlock);
            ...
            var isYAxisCorrect = deltaY > cameraYThresholdMin && deltaY < cameraYThresholdMax;
            var isLengthAxisCorrect = deltaLength < cameraXThresholdMax && deltaLength > cameraXThresholdMin;
            // Debug.Log(deltaLength);
            bool[] array = {isYAxisCorrect && isLengthAxisCorrect,isYAxisCorrect,isLengthAxisCorrect};
            return array;
        }
